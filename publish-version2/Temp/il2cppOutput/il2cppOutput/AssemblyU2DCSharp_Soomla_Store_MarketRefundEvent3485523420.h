...
struct  MarketRefundEvent_t3485523420  : public SoomlaEvent_t2098687264
{
public:
	// Soomla.Store.PurchasableVirtualItem Soomla.Store.MarketRefundEvent::mPurchasableVirtualItem
	PurchasableVirtualItem_t2555170966 * ___mPurchasableVirtualItem_2;

public:
	inline static int32_t get_offset_of_mPurchasableVirtualItem_2() { return static_cast<int32_t>(offsetof(MarketRefundEvent_t3485523420, ___mPurchasableVirtualItem_2)); }
